...
/// <summary>
/// Provides extension methods for configuring Monadic.Effect.Mediator services in the dependency injection container.
/// </summary>
/// <remarks>
/// The ServiceExtensions class contains utility methods that simplify the registration
/// of Monadic.Effect.Mediator services with the dependency injection system.
///
...
/// Monadic.Effect.Mediator system with minimal boilerplate code.
/// </remarks>
public static class ServiceExtensions
{
    ...
    /// <summary>
    /// Adds the effect workflow bus and registry to the Monadic effect configuration builder.
    /// </summary>
    ...
    /// <remarks>
    /// This method configures the Monadic.Effect system to use the workflow bus and registry
    ...
    /// when configuring the Monadic.Effect system.
    ///
    /// Example usage:
    /// ```csharp
    ...
    /// ```
    /// </remarks>
    public static MonadicEffectConfigurationBuilder AddEffectWorkflowBus(
