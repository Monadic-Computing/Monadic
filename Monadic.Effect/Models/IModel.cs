...
namespace Monadic.Effect.Models;

/// <summary>
/// Defines the contract for all persistable models within the Monadic.Effect system.
/// This interface serves as the base for all entities that can be tracked and stored
/// by effect providers.
/// </summary>
/// <remarks>
/// The IModel interface is a fundamental abstraction in the Monadic.Effect system.
...
public interface IModel
{
    ...
    /// a convention in the Monadic.Effect system to ensure compatibility
