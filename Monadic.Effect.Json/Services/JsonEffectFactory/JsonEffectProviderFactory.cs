...
/// which allows the Monadic.Effect system to create and use JSON effect providers without
...
public class JsonEffectProviderFactory(IServiceProvider serviceProvider) : IEffectProviderFactory
{
    ...
    ///
    /// The resolved provider is returned as an IEffectProvider, which allows the Monadic.Effect
