...
namespace Monadic.Effect.Services.EffectProviderFactory;

/// <summary>
/// Defines the contract for a factory that creates effect providers.
/// </summary>
/// <remarks>
/// The IEffectProviderFactory interface is part of the factory pattern used in the Monadic.Effect system.
