...
namespace Monadic.Effect.Parameter.Services.ParameterEffectProviderFactory;
...
///
/// This factory uses the Monadic effect configuration to obtain the JSON serialization options
...
/// which allows the Monadic.Effect system to create and use parameter effect providers without
/// directly depending on the concrete implementation.
/// </remarks>
/// <param name="configuration">The Monadic effect configuration containing JSON serialization options</param>
    ...
    : IParameterEffectProviderFactory
{
    ...
    ///
    /// The created provider is returned as an IEffectProvider, which allows the Monadic.Effect
