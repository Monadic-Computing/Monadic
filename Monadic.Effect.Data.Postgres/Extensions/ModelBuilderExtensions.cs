...
/// <summary>
/// Provides extension methods for configuring Entity Framework Core model builders for PostgreSQL in the Monadic.Effect.Data.Postgres system.
/// </summary>
/// <remarks>
/// The ModelBuilderExtensions class contains utility methods that simplify the configuration
/// of Entity Framework Core models for PostgreSQL in the Monadic.Effect.Data.Postgres system.
///
...
public static class ModelBuilderExtensions
{
    ...
    /// and configures it with the necessary enum mappings for the Monadic.Effect system.
    ///
