...
namespace Monadic.Effect.Utils;

/// <summary>
/// Provides standardized JSON serialization options for the Monadic.Effect system.
/// </summary>
/// <remarks>
/// The MonadicJsonSerializationOptions class defines a set of default serialization
/// options that are used throughout the Monadic.Effect system. These options ensure
...
/// JSON data in the Monadic.Effect system, ensuring consistent behavior.
/// </remarks>
public static class MonadicJsonSerializationOptions
{
    /// <summary>
    /// Gets or sets the default JSON serializer options for the Monadic.Effect system.
    /// </summary>
    /// <remarks>
    ...
    /// special types and formatting requirements of the Monadic.Effect system.
    ///
    /// The options include:
