...
namespace Monadic.Effect.Data.Services.IDataContextFactory;

/// <summary>
/// Defines the contract for a factory that creates database contexts for the Monadic.Effect.Data system.
/// This interface extends IEffectProviderFactory to integrate with the EffectRunner.
/// </summary>
/// <remarks>
/// The IDataContextProviderFactory interface is a key abstraction in the Monadic.Effect.Data system.
/// It serves as a bridge between the Monadic.Effect tracking system and database persistence,
